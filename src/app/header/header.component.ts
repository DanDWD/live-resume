  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Live Resume - Daniel Desplaces",
        text: "Hello, I'm a Full-stack Java Web Developer with 4+ years of experience designing web and mobile projects. Find out more in my live-resume!",
        url: "https://danieldesplaces.com/"
      });
    } catch(error) {
